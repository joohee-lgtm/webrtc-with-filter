...
- ios 사파리에서는 api를 제공하지 않기 때문에 webgl 로 동일한 효과를 낼 수 있다. 
    - [참고) 4.limitaions.md](./4.limitaions.md) / [참고) Browser compatibility](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/filter#Browser_compatibility)
